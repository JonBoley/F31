...
title(sprintf('SUMCOR_A (adj. peak=%.2f)',SACSCCmetrics.SCpeaks_A),'Interpreter','none');
set(gca, 'Box', 'off', 'TickDir', 'out');
...
plot(zeros(1,2),YLIMIT_SC*[0 1],'--k'); hold off
xlim(XLIMIT_delay*[-1 1]); ylim([YLIMIT_SClow YLIMIT_SC]);
title(sprintf('SUMCOR_B (adj. peak=%.2f)',SACSCCmetrics.SCpeaks_B),'Interpreter','none');
set(gca, 'Box', 'off', 'TickDir', 'out');
...
xlim(XLIMIT_delay*[-1 1]);  ylim([YLIMIT_SClow YLIMIT_SC]);
set(gca, 'Box', 'off', 'TickDir', 'out');
title(sprintf('SUMCOR_AB (adj. peak=%.2f)',SACSCCmetrics.SCpeaks_AB),'Interpreter','none');
