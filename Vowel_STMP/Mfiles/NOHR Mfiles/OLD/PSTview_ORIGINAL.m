...
% Later:6) Verify all picts are the same, with concatspikes
%
% *6) Setup for vowels
...
%     - 070804: 3.07: TrBF, some EHrBF to test
% 7) Setup general Analysis of single unit: 
%        A) - database:
%        B) - Summary Plot for tones: r,s,p vs L, f
%
%        - extend to vowels
%        - setup SCC
...
%%%%%%%%% MAKE into general NOHRtemplate.m Mfile
