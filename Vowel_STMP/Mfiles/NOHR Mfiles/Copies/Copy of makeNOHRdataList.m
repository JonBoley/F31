...
%    disp(sprintf('HARD CODED: UNITind: %d',UNITind))
   ...
   DataList.Units{TUlist(UNITind,1),TUlist(UNITind,2)}.Info.Threshold_dBatten= ...
      DataList.Units{TUlist(UNITind,1),TUlist(UNITind,2)}.TC{DataList.Units{TUlist(UNITind,1),TUlist(UNITind,2)}.Info.TCindToUse}.book_Thr_dBatt;  % Use TCindToUse data
