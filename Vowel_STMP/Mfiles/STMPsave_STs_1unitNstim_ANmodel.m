function STMPsave_STs_1unitNstim_ANmodel(ExpDate,UnitName,STIMtype,modelPARAMS)
% 6/12/09: Changed name to *_ANmodel (instead of *_interleaved)
...
if isempty(ddd)
    eval(['cd ''' RAWdata_dir ''''])
    GENsave_UnitINFO(TrackNum,UnitNum,1,modelPARAMS);  % skip verify
end
