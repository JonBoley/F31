...
%%%%%%%%%%%%%%%%%%%%%%%%%%% TODO 6/10/07 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% *1) finish DFTs
%% *2) setup RPS plots (FEAT/F0)
%% 3) setup SMP plot
%% 4) setup SAC/SCC 1 channel as in ARO/ISH (NSCC/CD as option)
%% 5) replicate ISH
%% 6) AN model
%% 7) TrBFi
...
figure(3+BASE10_FigureNUMS); clf
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(4+BASE10_FigureNUMS); clf
set(gcf,'DefaultTextInterpreter','none')
set(gcf,'units','norm','pos',[0.46   0.07    0.45    0.85])
