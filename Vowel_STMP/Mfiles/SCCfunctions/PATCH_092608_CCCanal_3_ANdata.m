function PATCH_092608_CCCanal_3_ANdata(ORIGfilename)
% File: PATCH_092608_CCCanal_3_ANdata.m
% M. Heinz
% Sept 26, 2008
%
% ANdata - has 2 cells for AB/AA or 1band/16band
%
...
%  -- save as NEWFileName (w, '_PATCH092608' behind ORIGFileName)

if ~exist('ORIGfilename','var'),    ORIGfilename='SCCs3BBNAB_1unitNstim.2.06.BBN_SX';   end
NEWfilename=[ORIGfilename '_PATCH092608'];

%% LOAD existing CCCanal Data
disp(sprintf('LOADING EXISTING CCCanal_3 file: %s.mat',ORIGfilename))
eval(['load ' ORIGfilename '.mat'])

% Loop through both conditions (AB/AB or 1band/16band)
for DATAind=1:2
	SACSCCfunctions=SCCsBBNAB_1unitNstim.SACSCCfunctions{DATAind};
	SACSCCmetrics=SCCsBBNAB_1unitNstim.SACSCCmetrics{DATAind};
	paramsOUT=SCCsBBNAB_1unitNstim.paramsOUT{DATAind};
	...
	SACSCCmetrics_prePATCH092608=SACSCCmetrics;
	clear SACSCCmetrics
	paramsOUT_prePATCH092608=paramsOUT;
	...
	% plot_CCCanal_3p(SACSCCfunctions,SACSCCmetrics_prePATCH092608,paramsOUT_prePATCH092608)
	...
	for BOOTrep=1:paramsOUT.BOOTSTRAP_Navgs+1
		...
		NumDrivenSpikes=SACSCCmetrics_prePATCH092608{BOOTrep}.NumDrivenSpikes;
		...
		SACSCCmetrics{BOOTrep}.AvgRate_sps=SACSCCmetrics_prePATCH092608{BOOTrep}.AvgRate_sps;
	...
	%% RE-store new CCCanal Data
	SCCsBBNAB_1unitNstim.SACSCCfunctions{DATAind}=SACSCCfunctions;
	SCCsBBNAB_1unitNstim.SACSCCmetrics{DATAind}=SACSCCmetrics;
	SCCsBBNAB_1unitNstim.paramsOUT{DATAind}=paramsOUT;
	SCCsBBNAB_1unitNstim.SACSCCmetrics_prePATCH092608{DATAind}=SACSCCmetrics_prePATCH092608;
	SCCsBBNAB_1unitNstim.paramsOUT_prePATCH092608{DATAind}=paramsOUT_prePATCH092608;
...
eval(['save ' NEWfilename '.mat SCCsBBNAB_1unitNstim'])
