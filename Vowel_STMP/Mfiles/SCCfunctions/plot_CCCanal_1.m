function plot_CCCanal_1(SACSCCfunctions,SACSCCmetrics,paramsIN)
...
subplot(5,3,13);
plot(SACSCCfunctions.freqVEC,SACSCCfunctions.rand.PSDsc_Aavg,'k');  xlim([0 XLIMIT_PSDhigh]); ylim([0 YLIMIT_PSD]); hold on
plot(ones(1,2)*paramsIN.CCCenv_LOWmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2);
plot(ones(1,2)*paramsIN.CCCenv_HIGHmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2); hold off
set(gca, 'Box', 'off', 'TickDir', 'out');
...
subplot(5,3,14);
plot(SACSCCfunctions.freqVEC,SACSCCfunctions.rand.PSDsc_Bavg,'k');  xlim([0 XLIMIT_PSDhigh]); ylim([0 YLIMIT_PSD]); hold on
plot(ones(1,2)*paramsIN.CCCenv_LOWmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2);
plot(ones(1,2)*paramsIN.CCCenv_HIGHmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2); hold off
set(gca, 'Box', 'off', 'TickDir', 'out');
...
subplot(5,3,15);
plot(SACSCCfunctions.freqVEC,SACSCCfunctions.rand.CSDsc_ABavg,'k');  xlim([0 XLIMIT_PSDhigh]); ylim([ 0 YLIMIT_PSD]); hold on
plot(ones(1,2)*paramsIN.CCCenv_LOWmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2);
plot(ones(1,2)*paramsIN.CCCenv_HIGHmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2); hold off
set(gca, 'Box', 'off', 'TickDir', 'out');
