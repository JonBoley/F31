...
% Find indicies for SCpeak and CCCenvs TOUSE
...
plot(ones(1,2)*paramsIN.CCCenv_HIGHmod_Hz,[0 YLIMIT_PSD],'--k','linewidth',2); hold off
set(gca, 'Box', 'off', 'TickDir', 'out');
text(1,1,sprintf('%s=%.2f',texlabel('rho_{ENV}'),SACSCCmetrics.CCCenv),'units','norm','VerticalAlignment','top','HorizontalAlignment','right','FontSize',12,'Color','red')
