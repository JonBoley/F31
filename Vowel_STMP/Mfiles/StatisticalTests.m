...
%         matrix{1} = [matrix{1} arrayCDatHalfOct.nh{m,n}(NHindex)];
%         matrix{2} = [matrix{2} arrayCDatHalfOct.snhl{m,n}(SNHLindex)];
%         matrix{3} = [matrix{3} arrayCDatHalfOct.linear{m,n}(NALindex)];
%         matrix{4} = [matrix{4} arrayCDatHalfOct.nonlinear{m,n}(DSLindex)];
    end
end
...
errorbar([1:4],[median(matrix{1}(~isnan(matrix{1}))),...
...
%     [std(matrix{1}(~isnan(matrix{1})))/sqrt(numel(matrix{1}(~isnan(matrix{1})))),...
%     std(matrix{2}(~isnan(matrix{2})))/sqrt(numel(matrix{2}(~isnan(matrix{2})))),...
%     std(matrix{3}(~isnan(matrix{3})))/sqrt(numel(matrix{3}(~isnan(matrix{3})))),...
%     std(matrix{4}(~isnan(matrix{4})))/sqrt(numel(matrix{4}(~isnan(matrix{4}))))],'ko-');
